...
const tryParser = require("./../build/try-parser.js"); 

// Create a Parser object from our grammar.
const parser = new nearley.Parser(nearley.Grammar.fromCompiled(tryParser));
...
parser_tests.forEach((test, i) => {
    ...
    try {
        ...
        if(parser.results.length > 1) {
            console.error("ambiguious gammar! triggered by:", ps);
        }
